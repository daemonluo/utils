...
/** <code>opt.immutable.OptionParser</code> is instantiated within your object,
 ...
 * {{{
 * val parser = new opt.immutable.OptionParser[Config]("opt", "2.x") { def options = Seq(
...
abstract case class OptionParser[C](
    ...
    def this(programName: String, version: String, errorOnUnknownArgument: Boolean) = this(Some(programName), Some(version), errorOnUnknownArgument)
     ...
     * @param action callback function
     */     
    def opt(shortopt: String, longopt: String, valueName: String, description: String)(action: (String, C) => C) = {
     ...
     * @param action callback function
     */ 
    def opt(shortopt: Option[String], longopt: String, valueName: String, description: String)(action: (String, C) => C) = {
    ...
    def intOpt(shortopt: String, longopt: String, valueName: String, description: String)(action: (Int, C) => C) = {
        new IntArgOptionDefinition[C](Some(shortopt), longopt, valueName, description, action)
    }

    def intOpt(shortopt: Option[String], longopt: String, valueName: String, description: String)(action: (Int, C) => C) = {
    ...
    def doubleOpt(shortopt: String, longopt: String, valueName: String, description: String)(action: (Double, C) => C) = {
        new DoubleArgOptionDefinition[C](Some(shortopt), longopt, valueName, description, action)
    }

    def doubleOpt(shortopt: Option[String], longopt: String, valueName: String, description: String)(action: (Double, C) => C) = {
    ...
    def booleanOpt(shortopt: String, longopt: String, valueName: String, description: String)(action: (Boolean, C) => C) = {
        new BooleanArgOptionDefinition[C](Some(shortopt), longopt, valueName, description, action)
    }

    def booleanOpt(shortopt: Option[String], longopt: String, valueName: String, description: String)(action: (Boolean, C) => C) = {
    ...
    def keyValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String)(action: (String, String, C) => C) = {
        new KeyValueArgOptionDefinition[C](Some(shortopt), longopt, keyName, valueName, description, action)
    }
    
    def keyValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String)(action: (String, String, C) => C) = {
    ...
    def keyIntValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String)(action: (String, Int, C) => C) = {
        new KeyIntValueArgOptionDefinition[C](Some(shortopt), longopt, keyName, valueName, description, action)
    }

    def keyIntValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String)(action: (String, Int, C) => C) = {
    ...
    def keyDoubleValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String)(action: (String, Double, C) => C) = {
        new KeyDoubleValueArgOptionDefinition[C](Some(shortopt), longopt, keyName, valueName, description, action)
    }

    def keyDoubleValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String)(action: (String, Double, C) => C) = {
    ...
    def keyBooleanValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String)(action: (String, Boolean, C) => C) = {
        new KeyBooleanValueArgOptionDefinition[C](Some(shortopt), longopt, keyName, valueName, description, action)
    }

    def keyBooleanValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String)(action: (String, Boolean, C) => C) = {
    ...
    def help(shortopt: String, longopt: String, description: String) = {
        new FlagOptionDefinition[C](Some(shortopt), longopt, description, {c: C => this.showUsage;c})
    }

    def help(shortopt: Option[String], longopt: String, description: String) = {
        new FlagOptionDefinition[C](shortopt, longopt, description, {c: C => this.showUsage;c})
    }

    def separator(description: String) = new SeparatorDefinition[C](description)
