 ...
 * {{{
 * val parser = new OptionParser("opt") {
...
case class OptionParser(
...
) extends GenericOptionParser[Unit] {
    ...
    def this(programName: String, errorOnUnknownArgument: Boolean) = this(Some(programName), None, errorOnUnknownArgument)
    ...
    def opt(shortopt: String, longopt: String, description: String, action: String => Unit) = {
        add(new ArgOptionDefinition(Some(shortopt), longopt, defaultValueName, description, { (s: String, _) => action(s) }))
    }
    ...
    def opt(longopt: String, description: String, action: String => Unit) = {
        add(new ArgOptionDefinition(None, longopt, defaultValueName, description, { (s: String, _) => action(s) }))
    }
    ...
    def opt(shortopt: String, longopt: String, valueName: String, description: String, action: String => Unit) = {
        add(new ArgOptionDefinition(Some(shortopt), longopt, valueName, description, { (s: String, _) => action(s) }))
    }
     ...
     * @param action callback function
     */ 
    def opt(shortopt: Option[String], longopt: String, valueName: String, description: String, action: String => Unit) = {
        add(new ArgOptionDefinition(shortopt, longopt, valueName, description, { (s: String, _) => action(s) }))
    }
    ...
    def intOpt(shortopt: String, longopt: String, description: String, action: Int => Unit) = {
        add(new IntArgOptionDefinition(Some(shortopt), longopt, defaultValueName, description, {(i: Int, _) => action(i)}))
    }

    def intOpt(longopt: String, description: String, action: Int => Unit) = {
        add(new IntArgOptionDefinition(None, longopt, defaultValueName, description, {(i: Int, _) => action(i)}))
    }

    def intOpt(shortopt: String, longopt: String, valueName: String, description: String, action: Int => Unit) = {
        add(new IntArgOptionDefinition(Some(shortopt), longopt, valueName, description, {(i: Int, _) => action(i)}))
    }

    def intOpt(shortopt: Option[String], longopt: String, valueName: String, description: String, action: Int => Unit) = {
        add(new IntArgOptionDefinition(shortopt, longopt, valueName, description, {(i: Int, _) => action(i)}))
    }

    def doubleOpt(shortopt: String, longopt: String, description: String, action: Double => Unit) = {
        add(new DoubleArgOptionDefinition(Some(shortopt), longopt, defaultValueName, description, {(d: Double, _) => action(d)}))
    }

    def doubleOpt(longopt: String, description: String, action: Double => Unit) = {
        add(new DoubleArgOptionDefinition(None, longopt, defaultValueName, description, {(d: Double, _) => action(d)}))
    }

    def doubleOpt(shortopt: String, longopt: String, valueName: String, description: String, action: Double => Unit) = {
        add(new DoubleArgOptionDefinition(Some(shortopt), longopt, valueName, description, {(d: Double, _) => action(d)}))
    }

    def doubleOpt(shortopt: Option[String], longopt: String, valueName: String, description: String, action: Double => Unit) = {
        add(new DoubleArgOptionDefinition(shortopt, longopt, valueName, description, {(d: Double, _) => action(d) }))
    }

    def booleanOpt(shortopt: String, longopt: String, description: String, action: Boolean => Unit) = {
        add(new BooleanArgOptionDefinition(Some(shortopt), longopt, defaultValueName, description, {(b: Boolean, _) => action(b)}))
    }

    def booleanOpt(longopt: String, description: String, action: Boolean => Unit) = {
        add(new BooleanArgOptionDefinition(None, longopt, defaultValueName, description, {(b: Boolean, _) => action(b)}))
    }

    def booleanOpt(shortopt: String, longopt: String, valueName: String, description: String, action: Boolean => Unit) = {
        add(new BooleanArgOptionDefinition(Some(shortopt), longopt, valueName, description, {(b: Boolean, _) => action(b) }))
    }

    def booleanOpt(shortopt: Option[String], longopt: String, valueName: String, description: String, action: Boolean => Unit) = {
        add(new BooleanArgOptionDefinition(shortopt, longopt, valueName, description, {(b: Boolean, _) => action(b)}))
    }

    def keyValueOpt(shortopt: String, longopt: String, description: String, action: (String, String) => Unit) = {
        add(new KeyValueArgOptionDefinition(Some(shortopt), longopt, defaultKeyName, defaultValueName, description, { (k: String, v: String, _) =>
            action(k, v)
        }))
    }

    def keyValueOpt(longopt: String, description: String, action: (String, String) => Unit) = {
        add(new KeyValueArgOptionDefinition(None, longopt, defaultKeyName, defaultValueName, description, {(k: String, v: String, _) => action(k, v)}))
    }
    ...
    def keyValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String, action: (String, String) => Unit) = {
        add(new KeyValueArgOptionDefinition(Some(shortopt), longopt, keyName, valueName, description, { (k: String, v: String, _) =>
            action(k, v)
        }))
    }

    def keyValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String, action: (String, String) => Unit) = {
        add(new KeyValueArgOptionDefinition(shortopt, longopt, keyName, valueName, description, {(k: String, v: String, _) => action(k, v) }))
    }

    def keyIntValueOpt(shortopt: String, longopt: String, description: String, action: (String, Int) => Unit) = {
        add(new KeyIntValueArgOptionDefinition(Some(shortopt), longopt, defaultKeyName, defaultValueName, description, { (k: String, v: Int, _) =>
            action(k, v)
        }))
    }

    def keyIntValueOpt(longopt: String, description: String, action: (String, Int) => Unit) = {
        add(new KeyIntValueArgOptionDefinition(None, longopt, defaultKeyName, defaultValueName, description, {(k: String, v: Int, _) => action(k, v)}))
    }
    ...
    def keyIntValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String, action: (String, Int) => Unit) = {
        add(new KeyIntValueArgOptionDefinition(Some(shortopt), longopt, keyName, valueName, description, {(k: String, v: Int, _) => action(k, v) }))
    }

    def keyIntValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String, action: (String, Int) => Unit) = {
        add(new KeyIntValueArgOptionDefinition(shortopt, longopt, keyName, valueName, description, {(k: String, v: Int, _) => action(k, v)}))
    }

    def keyDoubleValueOpt(shortopt: String, longopt: String, description: String, action: (String, Double) => Unit) = {
        add(new KeyDoubleValueArgOptionDefinition(Some(shortopt), longopt, defaultKeyName, defaultValueName, description, {(k: String, v: Double, _) =>
            action(k, v)
        }))
    }

    def keyDoubleValueOpt(longopt: String, description: String, action: (String, Double) => Unit) = {
        add(new KeyDoubleValueArgOptionDefinition(None, longopt, defaultKeyName, defaultValueName, description, { (k: String, v: Double, _) =>
            action(k, v)
        }))
    }
    ...
    def keyDoubleValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String, action: (String, Double) => Unit) = {
        add(new KeyDoubleValueArgOptionDefinition(Some(shortopt), longopt, keyName, valueName, description, {(k: String, v: Double, _) => action(k, v)}))
    }

    def keyDoubleValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String, action: (String, Double) => Unit) = {
        add(new KeyDoubleValueArgOptionDefinition(shortopt, longopt, keyName, valueName, description, {(k: String, v: Double, _) => action(k, v)}))
    }

    def keyBooleanValueOpt(shortopt: String, longopt: String, description: String, action: (String, Boolean) => Unit) = {
        add(new KeyBooleanValueArgOptionDefinition(Some(shortopt), longopt, defaultKeyName, defaultValueName, description, {(k: String, v: Boolean, _) => action(k, v)}))
    }

    def keyBooleanValueOpt(longopt: String, description: String, action: (String, Boolean) => Unit) = {
        add(new KeyBooleanValueArgOptionDefinition(None, longopt, defaultKeyName, defaultValueName, description, { (k: String, v: Boolean, _) =>
            action(k, v)
        }))
    }
    ...
    def keyBooleanValueOpt(shortopt: String, longopt: String, keyName: String, valueName: String, description: String, action: (String, Boolean) => Unit) = {
        add(new KeyBooleanValueArgOptionDefinition(Some(shortopt), longopt, keyName, valueName, description, { (k: String, v: Boolean, _) =>
            action(k, v)
        }))
    }

    def keyBooleanValueOpt(shortopt: Option[String], longopt: String, keyName: String, valueName: String, description: String, action: (String, Boolean) => Unit) = {
        add(new KeyBooleanValueArgOptionDefinition(shortopt, longopt, keyName, valueName, description, {(k: String, v: Boolean, _) => action(k, v)}))
    }

    def help(shortopt: String, longopt: String, description: String) = {
        add(new FlagOptionDefinition(Some(shortopt), longopt, description, {_ => this.showUsage}))
    }

    def help(shortopt: Option[String], longopt: String, description: String) = {
        add(new FlagOptionDefinition(shortopt, longopt, description, {_ => this.showUsage}))
    }
    ...
    def argOpt(name: String, description: String, action: String => Unit) = {
        add(new Argument(name, description, 0, 1, {(s: String, _) => action(s)}))
    }
    ...
    def arglist(name: String, description: String, action: String => Unit) = {
        add(new Argument(name, description, 1, UNBOUNDED, {(s: String, _) => action(s) }))
    }
    ...
    def arglistOpt(name: String, description: String, action: String => Unit) = {
        add(new Argument(name, description, 0, UNBOUNDED, {(s: String, _) => action(s)}))
    }
}
