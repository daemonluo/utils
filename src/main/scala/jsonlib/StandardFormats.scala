...
trait StandardFormats {
    ...
    private[jsonlib] type JF[T] = JsonFormat[T] // simple alias for reduced verbosity
    ...
    implicit def tuple5Format[A : JF, B : JF, C : JF, D : JF, E : JF] = new RootJsonFormat[(A, B, C, D, E)] {
        def write(t: (A, B, C, D, E)) = JsArray(t._1.toJson, t._2.toJson, t._3.toJson, t._4.toJson, t._5.toJson)
        def read(value: JsValue) = value match {
            case JsArray(Seq(a, b, c, d, e)) => (a.convertTo[A], b.convertTo[B], c.convertTo[C], d.convertTo[D], e.convertTo[E])
            case x => deserializationError("Expected Tuple5 as JsArray, but got " + x)
        }
    }

    implicit def tuple6Format[A : JF, B : JF, C : JF, D : JF, E : JF, F : JF] = new RootJsonFormat[(A, B, C, D, E, F)] {
        def write(t: (A, B, C, D, E, F)) = JsArray(t._1.toJson, t._2.toJson, t._3.toJson, t._4.toJson, t._5.toJson, t._6.toJson)
        def read(value: JsValue) = value match {
            case JsArray(Seq(a, b, c, d, e, f)) => (a.convertTo[A], b.convertTo[B], c.convertTo[C], d.convertTo[D], e.convertTo[E], f.convertTo[F])
            case x => deserializationError("Expected Tuple6 as JsArray, but got " + x)
        }
    }

    implicit def tuple7Format[A : JF, B : JF, C : JF, D : JF, E : JF, F : JF, G : JF] = new RootJsonFormat[(A, B, C, D, E, F, G)] {
        def write(t: (A, B, C, D, E, F, G)) = JsArray(t._1.toJson, t._2.toJson, t._3.toJson, t._4.toJson, t._5.toJson, t._6.toJson, t._7.toJson)
        def read(value: JsValue) = value match {
            case JsArray(Seq(a, b, c, d, e, f, g)) => (a.convertTo[A], b.convertTo[B], c.convertTo[C], d.convertTo[D], e.convertTo[E], f.convertTo[F], g.convertTo[G])
